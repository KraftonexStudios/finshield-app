...
class FirebaseService {
  ...
  async sendOTP(mobile: string): Promise<string> {
    try {
      ...
      const response = await fetch(
        "https://finshield-backend.onrender.com/api/send-otp",
        {
          method: "POST",
          headers: {
  ...
  async verifyOTP(verificationId: string, otp: string): Promise<FirebaseUser> {
    try {
      ...
      const response = await fetch(
        "https://finshield-backend.onrender.com/api/verify-otp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async resendOTP(mobile: string): Promise<string> {
    try {
      ...
      const response = await fetch(
        "https://finshield-backend.onrender.com/api/resend-otp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
